      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold leading-tight mb-6 text-primary">
              We Build Software That{" "}
              <span className="gradient-text">Drives Results</span>
            </h2>
            <p className="text-secondary text-base sm:text-lg leading-relaxed mb-4">
              Swarajya Consultancy is a software engineering firm based in Mumbai, serving clients across India.
              We specialize in crafting premium digital products — from intuitive web applications
              and SaaS platforms to robust cybersecurity solutions and business intelligence dashboards.
            </p>
            <p className="text-secondary text-base sm:text-lg leading-relaxed">
              Our approach is simple: understand your business deeply, engineer solutions precisely,
              and deliver outcomes that exceed expectations. Every line of code we write is
              purpose-built for performance, security, and scale.
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {highlights.map((item, i) => (
              <motion.div
                ...
                className="glass rounded-2xl p-5 card-glow group"
              >
